...
var email = _interopRequireWildcard(require("./controllers/newsletter.controller"));
...
(0, _initialsetup.createRoles)(); //config
...
email.add_email_to_newsletter(); //app.use('/api', require('./routes/index'))
