    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.t2 = email;
          _context.next = 7;
          return regeneratorRuntime.awrap(_user["default"].encryptPassword(password));
        ...
        case 7:
          ...
          _context.next = 19;
          return regeneratorRuntime.awrap(_role["default"].find({
            name: {
              $in: role
            }
          }));
        ...
        case 23:
          _context.next = 25;
          return regeneratorRuntime.awrap(_role["default"].findOne({
            name: "user"
          }));
        ...
        case 29:
          ...
          _context.next = 36;
          return regeneratorRuntime.awrap(_email.transporter.sendMail(template, function (err, info) {
            if (err) {
              console.log(err);
            } else {
              console.log(info);
  ...
  return regeneratorRuntime.async(function signIn$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 6:
          _context2.next = 8;
          return regeneratorRuntime.awrap(_user["default"].comparePassword(req.body.password, userFound.password));
